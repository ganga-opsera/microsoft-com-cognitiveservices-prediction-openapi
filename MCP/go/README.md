# PredictionEndpoint MCP Server

This MCP (Model Content Protocol) server provides access to PredictionEndpoint API functionality through HTTP, HTTPS, and STDIO transport modes.
